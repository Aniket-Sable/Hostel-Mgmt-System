...
const { getAdminByEmail,storeAdminToken,getFirstApply,allocate,malelist,femalelist,getStatus,addManager,getAdmin, } = require("../api/admin/admin.service");
...
module.exports = { 
    checkToken : async(req,res,next) => {
        try{
            ...
            let token = req.cookies.Admincookie || req.headers['Authorization'];
